...
class EnterPasswordAgain extends StatefulWidget {
  ...
  @override
  _EnterPasswordAgainState createState() => _EnterPasswordAgainState();
}

class _EnterPasswordAgainState extends State<EnterPasswordAgain> {
