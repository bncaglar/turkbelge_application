...
import 'package:turkbelge_application/screens/MainScreen_screens/my_profile/profile_page/logIn_activity/log_in_activity_components/log_in_activity_back_btn.dart';
...
class BankDetailsNew extends StatefulWidget {
  ...
  BankDetailsNew({required this.bankCode});
...
class BankDetailsNewArguments {
  ...
  BankDetailsNewArguments({required this.bankCode});
}
